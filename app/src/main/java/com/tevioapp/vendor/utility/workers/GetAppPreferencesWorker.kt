...
@HiltWorker
class GetAppPreferencesWorker @AssistedInject constructor(
    ...
    override fun createWork(): Single<Result> {
        return authRepo.apiGetPreferences()
            .map { response ->
    ...
    companion object {
        fun createJob(context: Context) {
            ...
            val request = OneTimeWorkRequest.Builder(GetAppPreferencesWorker::class.java)
