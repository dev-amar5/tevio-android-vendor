...
class BlurView : FrameLayout {
    ...
    private fun init(attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        overlayColor =
            a.getColor(R.styleable.BlurView_blurOverlayColor, PreDrawBlurController.TRANSPARENT)
        a.recycle()
    }
    ...
    override fun onAttachedToWindow() {
        ...
        if (!isHardwareAccelerated) {
            Logger.e("BlurView can't be used in not hardware-accelerated window!")
        } else {
     ...
     */
    @JvmOverloads
    fun setupWith(rootView: ViewGroup, algorithm: BlurAlgorithm = blurAlgorithm): BlurViewFacade {
