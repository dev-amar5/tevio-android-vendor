...
import static com.tevioapp.vendor.utility.calender.widget.SingleDateAndTimeConstants.DAYS_PADDING;
...
import com.tevioapp.vendor.utility.calender.widget.DateWithLabel;
import com.tevioapp.vendor.utility.calender.widget.WheelAmPmPicker;
import com.tevioapp.vendor.utility.calender.widget.WheelDayOfMonthPicker;
import com.tevioapp.vendor.utility.calender.widget.WheelDayPicker;
import com.tevioapp.vendor.utility.calender.widget.WheelHourPicker;
import com.tevioapp.vendor.utility.calender.widget.WheelMinutePicker;
import com.tevioapp.vendor.utility.calender.widget.WheelMonthPicker;
import com.tevioapp.vendor.utility.calender.widget.WheelPicker;
import com.tevioapp.vendor.utility.calender.widget.WheelYearPicker;
...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    private static final int VISIBLE_ITEM_COUNT_DEFAULT = 5;
    ...
    public SingleDateAndTimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        pickers.addAll(Arrays.asList(daysPicker, minutesPicker, hoursPicker, amPmPicker, daysOfMonthPicker, monthPicker, yearsPicker));
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setTextColor(a.getColor(R.styleable.SingleDateAndTimePicker_picker_textColor, ContextCompat.getColor(context, R.color.black)));
        setSelectedTextColor(a.getColor(R.styleable.SingleDateAndTimePicker_picker_selectedTextColor, ContextCompat.getColor(context, R.color.black)));
        setSelectorColor(a.getColor(R.styleable.SingleDateAndTimePicker_picker_selectorColor, ContextCompat.getColor(context, R.color.gray)));
